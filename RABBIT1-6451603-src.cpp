...
void mul(long long int m1[][2],long long int m2[][2])
{
	...
	temp[0][0]=(m1[0][0]*m2[0][0] + m1[0][1]*m2[1][0])%modulo;
	temp[0][1]=(m1[0][0]*m2[0][1] + m1[0][1]*m2[1][1])%modulo;
	temp[1][0]=(m1[1][0]*m2[0][0] + m1[1][1]*m2[1][0])%modulo;
	temp[1][1]=(m1[1][0]*m2[0][1] + m1[1][1]*m2[1][1])%modulo;
	m1[0][0]=temp[0][0];
	m1[0][1]=temp[0][1];
	m1[1][1]=temp[1][1];
	m1[1][0]=temp[1][0];
